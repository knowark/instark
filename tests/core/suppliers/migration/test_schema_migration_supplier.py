...
from instark.core.suppliers import (
    MemoryTenantSupplier, SchemaMigrationSupplier)
from instark.core.suppliers.migration import (
...
def schema_migration_supplier(mock_tenant_supplier):
    zones = {
        "default": "postgresql://instark:instark@localhost/instark"
    }
