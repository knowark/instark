...
from .resources import (
    RootResource, ChannelResource, DeviceResource, MessageResource,
...
class RestApplication(web.Application):
    ...
    def _create_api(self) -> None:
        ...
        self._bind('/channels', ChannelResource(self.injector))
        self._bind('/devices', DeviceResource(self.injector))
        self._bind('/messages', MessageResource(self.injector))
        self._bind('/subscriptions', SubscriptionResource(self.injector))
